...
class GatedResNet(nn.Module):
    def __init__(self, out_dims, block, layers, initialization=True, activation=None):
        ...
        self.layer2 = self._make_layer(block, 128, layers[0], activation)
        self.layer3 = self._make_layer(block, 256, layers[0], activation)
        self.layer4 = self._make_layer(block, 512, layers[0], activation)
